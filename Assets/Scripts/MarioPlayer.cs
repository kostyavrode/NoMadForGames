...
public class MarioPlayer : MonoBehaviour
{
    ...
    private void SetDirection()
    {
        if (climbing) {
            ...
            direction.y = joystick.Vertical * moveSpeed;
        } else if (grounded && Input.GetButtonDown("Jump") || grounded && joystick.Vertical>0.8f) {
        ...
        direction.x = joystick.Horizontal * moveSpeed;
